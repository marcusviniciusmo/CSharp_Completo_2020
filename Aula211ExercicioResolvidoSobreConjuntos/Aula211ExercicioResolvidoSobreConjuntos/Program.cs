...
namespace Aula211ExercicioResolvidoSobreConjuntos
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * no nome de usuário e o instante em que o usuário acessou o site no padrão ISO 8601, separados por espaço,
             * conforme exemplo. Fazer um programa que leia o log de acessos a partir de um arquivo,
