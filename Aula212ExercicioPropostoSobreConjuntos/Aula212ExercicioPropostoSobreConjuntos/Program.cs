...
namespace Aula212ExercicioPropostoSobreConjuntos
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * 
             * Cada instrutor do portal pode ter vários cursos, sendo que um mesmo aluno pode se matricular
             * em quantos cursos quiser. Assim, o número total de alunos de um instrutor não é simplesmente a soma dos alunos
             * de todos os cursos que ele possui, pois pode haver alunos repetidos em mais de um curso.
             * 
